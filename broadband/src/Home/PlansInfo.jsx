const PlansInfo = () => {
  ...
  return (
    <div className="m-2 mt-20 py-10">
      <h2
        style={{ fontFamily: "MADE Gentle, sans-serif" }}
        className="text-center text-5xl mb-8"
      >
        All plans include
      </h2>
        ...
        {plans.map((plan, index) => (
          ...
          >
            <img
              src={plan.image}
              alt={plan.title}
              className="w-52 h-32 rounded object-cover"
            />
            <div className="flex flex-col justify-between">
              <img className="w-8 h-8 mb-4" src={plan.icon} alt={plan.title} />
